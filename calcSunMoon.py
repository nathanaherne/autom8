...
print('Dawn Local:    %s' % str(globalVars.dawn.astimezone(local_timezone)))
print('Sunrise UTC: %s' % str(globalVars.sunrise))
print('Sunrise Local:    %s' % str(globalVars.sunrise.astimezone(local_timezone)))
print('Noon UTC:    %s' % str(globalVars.noon))
print('Noon Local:    %s' % str(globalVars.noon.astimezone(local_timezone)))
print('Sunset UTC:  %s' % str(globalVars.sunset))
print('Subset Local:    %s' % str(globalVars.sunset.astimezone(local_timezone)))
print('Dusk UTC:    %s' % str(globalVars.dusk))
print('Dusk Local:    %s' % str(globalVars.dusk.astimezone(local_timezone)))
